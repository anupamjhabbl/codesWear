...
export default function Signup() {
    return (
        <div class="max-w-[300px] mx-auto mb-[80px]">
            <div class="flex flex-col items-center mt-[10vh]">
                ...
                <form>
                    ...
                    <button class="bg-indigo-500 hover:bg-indigo-700 text-white text-base rounded-lg py-2.5 px-5 transition-colors w-full text-[19px]">Sign Up</button>
                </form>
                <p class="text-center mt-3 text-md">Already have an account?
                    <Link href="/login" class="text-indigo-600">Log In</Link>
                </p>
